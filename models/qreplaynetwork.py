...
tensorflow.compat.v1.random.set_random_seed(3)
...
class QReplayNetworkModel(AbstractModel):
    ...
    def __init__(self, game, **kwargs):
        ...
        if kwargs.get("load", False) is False:
            ...
            #self.model.add(Dense(game.maze.size*2, activation="relu"))
            #self.model.add(Dense(game.maze.size, activation="relu"))
    ...
    def train(self,start_cell=(0,0) , stop_at_convergence=False, **kwargs):
        """ Train the model.
        ...
        episodes = max(kwargs.get("episodes", 200), 1)
